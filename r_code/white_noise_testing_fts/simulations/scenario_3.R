...
# The generated functional time series are i.i.d. Student-t (with 3 degrees of freedom) functional white noise with a common quadratic mean function
...
for (i in 1 : trials) {
  ...
  series <- simulate_quadratic_iid_t_fts(n_points = n_points,
