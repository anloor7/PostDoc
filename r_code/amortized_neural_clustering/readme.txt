...
- The folder ''scenario_3'' contains the Python script used for the analyses of Scenario 3 in the paper.

- The folder ''scenario_4'' contains the Python script used for the analyses of Scenario 4 in the paper.
