...
for (j in 1 : trials) {
  ...
  for (i in 1 : n_series) {
    ...
    series_1[[i]] <- simulate_tsetar_2(-0.5, 0.8, 0.3, 0.1, -0.1, -0.4, -0.3, 0.2, 1, series_length = series_length)
    series_2[[i]] <- simulate_tsetar_2(0, 0, 0.3, 0.1, 0, 0, -0.3, 0.2, 1, series_length = series_length)
    series_3[[i]] <- simulate_tsetar_2(-0.5, 0.8, 0, 0, -0.1, -0.4, 0, 0, 1, series_length = series_length)
